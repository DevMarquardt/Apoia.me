export default function RegisterComponent() {
    ...
    return (
        <>
            ...
            <div className="flex justify-center pt-24 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("https://as1.ftcdn.net/v2/jpg/02/79/12/42/1000_F_279124266_QRp7wTZ8SOm3zwkWKXgle3XoXOKr2PGI.jpg")' }}>
                <div className="pb-10 w-[30%]">
                <div className="  font-montserrat imagem text-white rounded-xl bg-pretoDiferente  font-semibold ">
